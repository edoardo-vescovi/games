...
Call E(x,y) the average (= expected value) of steps from the point (0,0) to (x,y). The absence of a preferred walking direction, the ant's starting point and the food location's rotational symmetry by 90 degrees imply $E(x,y)=E( &#177; x, &#177; y )=E(y,x)$.
