...
The absence of a preferred walking direction, the ant's starting point and the food location's symmetry imply E(x,y) is invariant under 90-degree rotations and reflection transformations: E(x,y)=E(&#177;x,&#177;y)=E(y,x). 
